...
const TabSection = () => {
  ...
  const lecturers = [
    { name: "Prof. Fathul Wahid", role: "Professor", image: "/avatar-placeholder.png" },
    { name: "Prof. Sri Kusumadewi", role: "Professor", image: "/avatar-placeholder.png" },
    { name: "Izzati Muhimmah, Ph.D", role: "Doctoral Lecturer", image: "/avatar-placeholder.png" },
    { name: "Dr. R. Teduh Dirgahayu", role: "Doctoral Lecturer", image: "/avatar-placeholder.png" },
    { name: "Ir. Dhomas Hatta Fudholi, Ph.D", role: "Doctoral Lecturer", image: "/avatar-placeholder.png" },
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-wrap justify-center mb-10 border-b border-gray-200">
          <button
            ...
            className={`flex items-center gap-2 px-8 py-4 text-sm font-bold uppercase tracking-wide transition-all border-b-4 ${
              activeTab === 'dosen'
                    ...
                    <div className="h-24 bg-blue-900 relative">
                       ...
                       <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 w-24 h-24 bg-white rounded-full p-1">
                          <div className="w-full h-full bg-gray-200 rounded-full overflow-hidden">
                            ...
                            <img 
                              src={`https://ui-avatars.com/api/?name=${dosen.name}&background=random`} 
                              alt={dosen.name} 
